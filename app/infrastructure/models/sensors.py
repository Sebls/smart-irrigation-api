...
class Sensor(Base, UUIDPrimaryKeyMixin, TimestampMixin, SoftDeleteMixin):
    ...
    activity_events: Mapped[list["ActivityEvent"]] = relationship(back_populates="sensor")

    __table_args__ = (
        CheckConstraint("type in ('humidity','temperature','air-quality')", name="ck_sensors_type"),
