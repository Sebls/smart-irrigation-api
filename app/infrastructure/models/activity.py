...
class ActivityEvent(Base, UUIDPrimaryKeyMixin):
    ...
    zone: Mapped["Zone | None"] = relationship(back_populates="activity_events")
    plant: Mapped["Plant | None"] = relationship(back_populates="activity_events")
    sensor: Mapped["Sensor | None"] = relationship(back_populates="activity_events")
